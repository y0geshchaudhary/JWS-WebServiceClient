 ...
 * generated in the com.yogesh package. 
...
public class ObjectFactory {
    ...
    private final static QName _DivResponse_QNAME = new QName("http://yogesh.com/", "divResponse");
    private final static QName _Sub_QNAME = new QName("http://yogesh.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://yogesh.com/", "subResponse");
    private final static QName _Add_QNAME = new QName("http://yogesh.com/", "add");
    private final static QName _Div_QNAME = new QName("http://yogesh.com/", "div");
    private final static QName _AddResponse_QNAME = new QName("http://yogesh.com/", "addResponse");
    private final static QName _Mul_QNAME = new QName("http://yogesh.com/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://yogesh.com/", "mulResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.yogesh
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://yogesh.com/", name = "mulResponse")
