 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://yogesh.com/", wsdlLocation = "http://localhost:8080/WebService/Calculate?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://yogesh.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebService/Calculate?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://yogesh.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://yogesh.com/", "CalculatorPort"), Calculator.class, features);
    }
